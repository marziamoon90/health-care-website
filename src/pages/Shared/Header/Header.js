    ...
    return (
        <div className="background-img nav-bar">
            <Navbar collapseOnSelect sticky="top" expand="lg" variant="light">
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-end">
                        <Nav>
                            <NavLink to="/login">
                                <Button className="login-button px-4 py-2 rounded-pill" variant="outline-info" ><i class="fas fa-sign-in-alt me-2 text-center"></i>Login</Button>
                            </NavLink>
                        </Nav>
                    </Navbar.Collapse>
                </Container>
            ...
            <div className="mx-5 my-5 fw-bold text-start w-50">
                <h1 className="title m-0"><i class="fas fa-spa"></i> Wellness Physiotherapy</h1>
